...
let myButton = document.querySelector(".btn-container")
...
function addButton(){
  myButton.innerHTML = createButton("ALL") + " " + createButton("KOREA") + " " + createButton("JAPAN") + " " + createButton("CHINA")
...
function foodCreator(foodName){
  let item = `<div class = "menu-items col-lg-6 col-sm-12">
  <img src = "${foodName.img}" alt = "${foodName.title}" class = "photo">
  <div class = "menu-info">
    <div class = "menu-title">
      <h4>${foodName.title}</h4>
